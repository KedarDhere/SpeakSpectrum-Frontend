...
export class TranscriptComponent {
  ...
  submitVideo() {
    ...
    this.http.post<any>('https://speakspectum-backend.onrender.com/uploadVideo', formData).subscribe(
      response => {
        const videoId = response.videoId;
        this.videoService.videoId = videoId;
        this.http.get<any>(`https://speakspectum-backend.onrender.com/getTranscript/${videoId}`, {}).subscribe(
          data => {
